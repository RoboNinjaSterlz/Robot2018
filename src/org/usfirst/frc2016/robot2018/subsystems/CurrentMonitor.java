...
*/
    	for (int i=0; i<numPdPorts; i++) {
    		if (currentStatus[i].name != null ) {
    			...
    			SmartDashboard.putNumber(currentStatus[i].name, currentStatus[9].failCount);    			
    			SmartDashboard.putNumber(currentStatus[i].name, powerDistributionPanel1.getCurrent(14));
    		}
    	}
