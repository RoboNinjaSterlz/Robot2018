...
public class AutoStartCenter extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        {
        	int moveEndLimit = 40; // ~325 counts/in : old setting 40 ~ 1/8";
        	int cruiseVel = 1720;   // old setting 1720
        	int accel = 1640;      // old setting 1640
	        ...
	        addSequential(new TestArcDrive(-82, -52, true, accel, cruiseVel, moveEndLimit));
	        addSequential(new TestArcDrive(-52, -82, false, accel, cruiseVel, moveEndLimit));
	        addSequential(new PlaceCube());
