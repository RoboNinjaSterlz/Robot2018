...
//    private final RobotDrive robotDrive = RobotMap.drivetrainRobotDrive;
   ...
   public DriveTrainSRX() {
   	...
   	talonDriveRight1.setInverted(false);
   	...
   	talonDriveRight2.setInverted(false);
   	...
   	talonDriveRight3.setInverted(false);
...
//        	robotDrive.arcadeDrive(Robot.oi.driveRight.getY(), steer);
        	differentialDrive.arcadeDrive(Robot.oi.driveRight.getY(), steer);
    	}
    	else {
