...
public class DriveTrainSRX extends Subsystem {
	...
	private final int COUNTS_PER_INCH = 100;  //Encoder counts / inch of travel
  ...
  // 	talonDriveRight1.setSafetyEnabled(false);
	...
	talonDriveLeft1.configPeakOutputForward(.5, 0);
	talonDriveLeft1.configPeakOutputReverse(-.5, 0);
	
	/* set acceleration and vcruise velocity - see documentation */
	talonDriveLeft1.configMotionCruiseVelocity(100, 0);
	talonDriveLeft1.configMotionAcceleration(200, 0);
	...
	talonDriveRight1.configPeakOutputForward(.5, 0);
	talonDriveRight1.configPeakOutputReverse(-.5, 0);
	
	/* set acceleration and vcruise velocity - see documentation */
	talonDriveRight1.configMotionCruiseVelocity(100, 0);
	talonDriveRight1.configMotionAcceleration(200, 0);
   }
