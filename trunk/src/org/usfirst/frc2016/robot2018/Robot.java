...
//		robotPrefs.doLoadPrefs();
		...
		autoChooser.addDefault(AutoPilotRobot.selectSwitchFrontBack, new AutoPilotCommand(AutoPilotRobot.selectSwitchFrontBack));
		autoChooser.addObject(AutoPilotRobot.selectSwitchFront, new AutoPilotCommand(AutoPilotRobot.selectSwitchFront));
		autoChooser.addObject(driveUsingFile, new DriveUsingFile());
		autoChooser.addObject(robotCenter, new AutoStartCenter());
