...
public class OI {
    ...
    public OI() {
        ...
        elevatorDownButton = new JoystickButton(driveLeft, 1);
        elevatorDownButton.whenPressed(new ElevatorDown());
        elevatorUpButton = new JoystickButton(driveLeft, 3);
        ...
        SmartDashboard.putData("AcquireCube", new AcquireCube());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        SmartDashboard.putData(AutoPilotRobot.selectSwitchFront, new AutoPilotCommand(AutoPilotRobot.selectSwitchFront, true));
        SmartDashboard.putData(AutoPilotRobot.selectSwitchFrontBack, new AutoPilotCommand(AutoPilotRobot.selectSwitchFrontBack, true));
