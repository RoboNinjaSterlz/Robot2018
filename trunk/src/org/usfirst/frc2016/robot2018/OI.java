...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("PlaceOrNot: Left", new PlaceOrNot("L"));
        SmartDashboard.putData("PlaceOrNot: Right", new PlaceOrNot("R"));
        ...
        SmartDashboard.putData("TestArcDrive: test 36 15", new TestArcDrive(0, 0));
