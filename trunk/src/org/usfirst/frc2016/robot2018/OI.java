...
public class OI {
    ...
    public OI() {
        ...
        armHighButton = new JoystickButton(operatorJoy, 11);
        ...
        openArmButton = new JoystickButton(operatorJoy, 1);
        openArmButton.whileHeld(new OpenArm());
        loadPrefs = new JoystickButton(operatorJoy, 5);
        ...
        SmartDashboard.putData("ArmLow", new ArmLow());
        SmartDashboard.putData("ArmMedium", new ArmMedium());
        SmartDashboard.putData("ArmHigh", new ArmHigh());
        SmartDashboard.putData("ShootCube", new ShootCube());
        ...
        SmartDashboard.putData("ArmFloor", new ArmFloor());
